...
class MailHelperImpl implements MailHelper {
	...
	return new MailSenderImpl(session);
    }
    ...
    @Override
    @Deprecated
    public MailMessage createMessage(MailAddress from, String subject) throws MailHelperException {
	return createBuilder().createMessage(from, null, subject);
    }

    @Override
    @Deprecated
    public MailMessage createMessage(MailAddress from, String subject, Charset charset)
    ...
    @Override
    @Deprecated
    public MailMessagePart createXMLPart(Document doc) throws MailHelperException {
	return createBuilder().createXMLPart(doc);
    }

    @Override
    @Deprecated
    public MailMessagePart createXMLPart(Document doc, Charset charset) throws MailHelperException {
