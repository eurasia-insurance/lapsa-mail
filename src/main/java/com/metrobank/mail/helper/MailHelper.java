...
public interface MailHelper {
    ...
    @Deprecated
    MailMessage createMessage(String subject, Charset charset) throws MailHelperException;

    @Deprecated
    MailMessage createMessage(MailAddress from, String subject) throws MailHelperException;

    @Deprecated
    MailMessage createMessage(MailAddress from, String subject, Charset charset) throws MailHelperException;

    @Deprecated
    MailMessage createMessage(MailAddress from, MailAddress to, String subject) throws MailHelperException;

    @Deprecated
    MailMessage createMessage(MailAddress from, MailAddress to, String subject, Charset charset)
    ...
    @Deprecated
    MailMessageTextPart createTextPart(String text, Charset charset) throws MailHelperException;

    @Deprecated
    MailMessageHTMLPart createHTMLPart(String html) throws MailHelperException;

    @Deprecated
    MailMessageHTMLPart createHTMLPart(String html, Charset charset) throws MailHelperException;

    @Deprecated
    MailMessagePart createXMLPart(Document doc) throws MailHelperException;

    @Deprecated
    MailMessagePart createXMLPart(Document doc, Charset charset) throws MailHelperException;
    ...
    @Deprecated
    MailAddress createAddress(String eMail, String name) throws MailHelperException;
